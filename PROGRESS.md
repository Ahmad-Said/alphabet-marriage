...
| 08           | مغالطات عقد القران                                                | `04-الباب-الرابع-عقد-القران/`       | `01-عقد-القران-زواج-مع-وقف-التنفيذ`, `02-المهر-والشروط-في-العقد`, `03-فقه-فترة-عقد-القران`, `04-تكاليف-الباب` | ✅ Full prose |
| 09           | مغالطات الزفاف وليلته                                             | `05-الباب-الخامس-الزفاف-وليلته/`    | `01-من-عقد-القران-إلى-الزفاف`, `02-الثلاثية-المحرمة-وفقه-الفرح`, `03-ليلة-البناء`, `04-تكاليف-الباب`          | ✅ Full prose |
| 10           | مغالطات ما بعد الزفاف                                             | `06-الباب-السادس-ما-بعد-الزفاف/`    | `01-مغالطات-شهر-العسل`, `02-مغالطات-السنة-الأولى`, `03-المشكلات-الزوجية-والطلاق`, `04-تكاليف-الباب` | ✅ Full prose |
| 11           | الأصول… ولكن! (خلاصات)                                            | `07-الباب-السابع-الأصول/`           | `01-أصول-لا-استثناء-لها`, `02-أصول-لها-استثناءات`                                                            | ✅ Full prose |
| 12           | أمانات ووصايا                                                     | `08-الباب-الثامن-أمانات-ووصايا/`    | `01-أمانات-ووصايا`                                                                                            | ✅ Full prose |
| 12-13, 13–21 | خطة المجالس + مجالس الأسئلة (إجابة أسئلة المقدمات 01–09 + خلاصات) | `09-الباب-التاسع-مجالس-الأسئلة/`    | `01-منهج-الأسئلة-ومنهاج-المجالس`, `02-أجوبة-تكمل-المقدمات`, `03-خلاصات-إجابات-الأسئلة`                        | ✅ Full prose |

### القسم الثاني — ما لا يسعنا جهله من فقه النفس

| Session(s) | Topic                                          | → Part folder                           | File(s)                           | Status     |
|------------|------------------------------------------------|-----------------------------------------|-----------------------------------|------------|
| 22–23      | صوارف ومعوقات وموانع (جـهـل، المخادعات)        | `10-الباب-العاشر-الصوارف-والمعوقات/`    | `01-الصوارف-والمعوقات-والمخادعات` | ✅ Full prose |
| 24         | تعريف فقه النفس (الطمأنينة/السعادة)            | `11-الباب-الحادي-عشر-تعريف-فقه-النفس/`  | `01-تعريف-فقه-النفس`              | ✅ Full prose |
| 25–28      | ممّ تتكون النفس (أمشاج، الجسد والروح، الحاجات) | `11-الباب-الحادي-عشر-...`               | `02-تكون-النفس-الجسد-والروح`      | ✅ Full prose |
| 28–29      | الحاجات + قلة المحتوى المادي (تأصيل)           | `12-الباب-الثاني-عشر-الحاجات-والإبانة/` | `01-الحاجات-وقلة-المحتوى-المادي`  | ✅ Full prose |
| 29         | الثقافة الشرائية + قوة الشخصية + الإبانة المبكرة | `12-الباب-الثاني-عشر-...`             | `02-الثقافة-الشرائية-وقوة-الشخصية` | ✅ Full prose |
| 29         | تجهيز البيت: حساب عملي (العرس/المهر/الأثاث)    | `12-الباب-الثاني-عشر-...`               | `03-تجهيز-البيت-حساب-عملي`        | ✅ Full prose |
| 30–32      | مسائل وأسئلة الاستعداد المادي (إجابة الجمهور)  | `12-الباب-الثاني-عشر-...`               | `04-مسائل-الاستعداد-المادي`       | ✅ Full prose |
| 33         | فقه الحاجات لحياة زوجية طيبة (جسدية/روحية)     | `12-الباب-الثاني-عشر-...`               | `05-فقه-الحاجات-لحياة-زوجية-طيبة` | ✅ Full prose |
| 34         | الإبانة والتعبير (حاجة الحاجة، لسان النفس)     | `12-الباب-الثاني-عشر-...`               | `06-الإبانة-والتعبير-حاجة-الحاجة` | ✅ Full prose |
| 35–42      | تطبيقات/خلاصات/قصص + مراجعات الجمهور 01–07     | `13-الباب-الثالث-عشر-تطبيقات-ومراجعات/` | `01-من-التنظير-إلى-العمل` … `06-فقه-الحاجة-في-المحن-وعبر` · `07-تكاليف` | ✅ Full prose |
...
- **Fully read:** 01, 02, 03, 04, 08, 09, 10, 11, 12, 22–34, **35, 36, 37, 38, 39, 40, 41, 42** (these are the ✅ chapters).
- **Openings skimmed:** 05, 06, 07, 12-13 (roadmap).
- **Filename-only (NOT yet read):** 13–21, 43–50. The 📝 outlines for these are derived from the
...
> 💡 **Structure is NOT fixed — optimize per chapter.** The file names / counts in §3 are a
> *starting suggestion*, not a contract. You are free (and encouraged) to re-divide, merge, rename,
> add, or drop files to whatever best represents the chapter's content. The governing principle is
> **fidelity over brevity**: cover *every* idea in the transcript rather than producing a light
> summary that loses content. When a session is dense (e.g. الاستعداد المادي s28–32 → split into 4
> فصول), make as many files as the material needs; when thin, merge. If you change the structure,
> update §3, the README table, this file's tree, the `00-تمهيد` فهرس, and all nav footers to match.
...
04-الباب-الرابع-عقد-القران/               00 تمهيد · 01..03 ✅ · 04 تكاليف ✅      (s8)
05-الباب-الخامس-الزفاف-وليلته/            00 تمهيد · 01..03 ✅ · 04 تكاليف ✅      (s9)
06-الباب-السادس-ما-بعد-الزفاف/            00 تمهيد · 01..03 ✅ · 04 تكاليف ✅      (s10)
07-الباب-السابع-الأصول/                   00 تمهيد · 01..02 ✅                     (s11)
...
12-الباب-الثاني-عشر-الحاجات-والإبانة/     00 تمهيد · 01..06 ✅                     (s28–34)
13-الباب-الثالث-عشر-تطبيقات-ومراجعات/     00 تمهيد · 01..06 ✅ · 07 تكاليف ✅       (s35–42)
14-الباب-الرابع-عشر-حاجات-الجنسين/        00 تمهيد · 01..02 📝                     (s43–50)
data/raw/                                 source transcripts (01..50; 06 duplicated)
```

_Last updated: 2026-06-07. **Part 13 now fully ✅** — transcripts 35–42 read fully (the dense
"الحاجة وما فوق الحاجة" applications session + 7 audience-review sessions), then the old combined
outline `01-تطبيقات-ومراجعات-وقصص` was promoted and split (fidelity over brevity) into **6 prose
فصول + تكاليف**: `01-من-التنظير-إلى-العمل` (framework + الضابط الوحي لا السوق + النفس قابلة
للترويض + منهج الباب) · `02-تطبيقات-على-البدن-واللباس` (الحمام/المنظفات/التجميل/الشعر/العطور/اللباس/
الأحذية/الشنط) · `03-تطبيقات-في-البيت-والمطبخ` (الأثاث/الفسحة/الصور + الطعام/الثلاجة/الماء/القمامة)
· `04-الحاجات-النفسية-بين-الزوجين` (الأمن والسكن/المقام والقوامة/التعبير والمودة والتسديد والمقاربة/
الجمال/التوافق) · `05-ما-فوق-الحاجة-في-دروب-الزواج` (المهر والجهاز والذهب/الفستان والعرس وعشاء
العروسين/الترفيه والمطاعم والخروج/عمل المرأة والأكاديميا والتربية/التواصل مع الأهل والمساجد) ·
`06-فقه-الحاجة-في-المحن-وعبر` (الدنيا تأخذ + قصص الثراء المفسد + فقه الحرب غزة/السودان + شهادات
الأنس بأقل القليل + الزواج ميثاق غليظ + خاتمة كعب بن مالك/ابن القيم/«كل شيء سعره فيه») ·
`07-تكاليف-الباب` (النموذجان + الأمثلة والحكم الشرعي + التدريبات العملية + التخفف + تكاليف القلب).
README/تمهيد/nav (incl. Part 14 back-link) all updated; old outline deleted. _(Prior session:
Part 8 rewritten for fidelity.)_ **Next: القسم الأول — Part 9 مجالس الأسئلة appears already ✅ on disk;
Parts 6 & 8 marked ✅ in §3 but README still shows 📝 (verify/sync). Then القسم الثاني Part 10 الصوارف
(✅ on disk) و especially Part 14 (حاجات الجنسين s43-50, heaviest, still 📝) — READ each transcript
fully first.**_
