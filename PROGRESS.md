...
- **Fully read:** 01, 02, 03, 04, 08 (these are the ✅ chapters).
- **Openings skimmed:** 05, 06, 07, 09, 10, 11, 12-13 (roadmap), 24.
...
_Last updated: 2026-06-07. Reworked from 10→50 sessions. Part 4 (عقد القِران, s8) promoted 📝→✅ — split into 3 فصول + تكاليف. **Next outline to promote: Part 5 (الزفاف وليلته, s9).**_
