...
- **Fully read:** 01, 02, 03, 04, 08, 09, 10, 11, 12, 22, 23, 24, 25, 26, 27, 28 (these are the ✅ chapters).
- **Openings skimmed:** 05, 06, 07, 12-13 (roadmap).
- **Filename-only (NOT yet read):** 13–21, 29–50. The 📝 outlines for these are derived from the
...
_Last updated: 2026-06-07. Part 11 (تعريف فقه النفس، s24-28) promoted 📝→✅ — full prose written from transcripts fully read. **Next: Part 12 (الحاجات والإبانة، s28-34).**_
